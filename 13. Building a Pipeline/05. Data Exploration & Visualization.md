...
Celle du dessus fait référence au KQL (Kibana Query Language)
Celle du dessous fait référence au DSL (Domain Specific Language)
Vous pouvez les combinez pour créer des filtres efficaces. 
